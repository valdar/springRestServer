...
{
	//XXX: You should configure this appropriately for your environment
	private static final String LOG_PATH = "./yyyy_mm_dd.request.log";
	
	private static final String WEB_XML = "META-INF/webapp/WEB-INF/web.xml";
    private static final String CLASS_ONLY_AVAILABLE_IN_IDE = "it.andrea.tarocchi.restServer.RestServerServiceTest";
    ...
    {
    	//XXX: You should configure these appropriately for your environment - this is an example only
